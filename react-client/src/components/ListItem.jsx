...
export default class ListItem extends React.Component {
  ...
  render() {
    return (
    	<div className="yelp-list-entry-container" style={this.state.style} onClick={(e)=> {
        e.preventDefault();
        this.props.handleClick(this.props.item)
          ...
          <div className="listing-body">
            <a  target="_blank" href={`http://maps.google.com/?daddr=${this.props.item.name} ${this.props.item.location.address1} ${this.props.item.location.city}&saddr=${this.props.startPoint.lat || ''},${this.props.startPoint.lng || ''}`}>
